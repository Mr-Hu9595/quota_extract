...
// Update 1-2-5 with data from 16-14-15-048.jpg
const quota1_2_5 = data.quotas.find(q => q.code === '1-2-5');
if (quota1_2_5) {
  quota1_2_5.comprehensive_price = 10384.69;
  quota1_2_5.labor_fee = 5097.16;
  quota1_2_5.material_fee = 377.73;
  quota1_2_5.mechanical_fee = 1439.91;
  quota1_2_5.source_screenshot = 'bandicam 2026-04-27 16-14-15-048.jpg';
  quota1_2_5.labor_details = [
  ...
  screenshotMap['1-2-5'] = 'bandicam 2026-04-27 16-14-15-048.jpg';
}

// Update 1-2-6 with data from 16-14-32-073.jpg
const quota1_2_6 = data.quotas.find(q => q.code === '1-2-6');
if (quota1_2_6) {
  quota1_2_6.comprehensive_price = 14875.18;
  quota1_2_6.labor_fee = 7417.55;
  quota1_2_6.material_fee = 533.52;
  quota1_2_6.mechanical_fee = 2277.02;
  quota1_2_6.source_screenshot = 'bandicam 2026-04-27 16-14-32-073.jpg';
  quota1_2_6.labor_details = [
  ...
  console.log('Updated 1-2-6');
  screenshotMap['1-2-6'] = 'bandicam 2026-04-27 16-14-32-073.jpg';
}

// Update 1-2-7 with data from 16-14-44-974.jpg
const quota1_2_7 = data.quotas.find(q => q.code === '1-2-7');
if (quota1_2_7) {
  quota1_2_7.comprehensive_price = 17370.35;
  quota1_2_7.labor_fee = 9020.77;
  quota1_2_7.material_fee = 830.20;
  quota1_2_7.mechanical_fee = 2642.00;
  quota1_2_7.source_screenshot = 'bandicam 2026-04-27 16-14-44-974.jpg';
  quota1_2_7.labor_details = [
  ...
  console.log('Updated 1-2-7');
  screenshotMap['1-2-7'] = 'bandicam 2026-04-27 16-14-44-974.jpg';
}

// Update 1-2-8 with data from 16-14-51-366.jpg
const quota1_2_8 = data.quotas.find(q => q.code === '1-2-8');
if (quota1_2_8) {
  quota1_2_8.comprehensive_price = 25669.11;
  quota1_2_8.labor_fee = 13455.00;
  quota1_2_8.material_fee = 1222.00;
  quota1_2_8.mechanical_fee = 3788.00;
  quota1_2_8.source_screenshot = 'bandicam 2026-04-27 16-14-51-366.jpg';
  quota1_2_8.labor_details = [
  ...
  console.log('Updated 1-2-8');
  screenshotMap['1-2-8'] = 'bandicam 2026-04-27 16-14-51-366.jpg';
}
...
console.log('Saved to JSON and map');