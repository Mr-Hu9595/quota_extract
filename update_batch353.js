...
const newQuotas = [
  {
    ...
    material_details: [
      ...
      {code:'14090119', name:'黄油钠基脂', spec:'', unit:'kg', quantity:4.04, quota_price:11.2, market_price:11.2, total:45.25},
      {code:'03131515', name:'铜焊粉', spec:'', unit:'kg', quantity:0.112, quota_price:20.8, market_price:20.8, total:2.33},
  ...
  },
  {
    ...
    material_details: [
      ...
      {code:'03131515', name:'调摩粉', spec:'', unit:'kg', quantity:0.128, quota_price:20.8, market_price:20.8, total:2.66},
      {code:'QTCLF-1', name:'其他材料费', spec:'', unit:'%', quantity:132.44187, quota_price:1, market_price:1, total:132.44}
    ],
    mechanical_details: [
      {code:'990401035', name:'载重汽车', spec:'装载质量(t) 10', unit:'台班', quantity:1.5, quota_price:573.79, market_price:573.79, total:860.69},
      {code:'990304028', name:'汽车式起重机', spec:'提升质量(t) 30', unit:'台班', quantity:6, quota_price:1058.74, market_price:1058.74, total:6352.42},
